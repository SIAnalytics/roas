...
if __name__ == '__main__':
    roitransformer = DetectorModel(r'configs/ROAS/faster_rcnn_RoITrans_r101_fpn_2x_roas_768.py',
                  r'work_dirs/faster_rcnn_RoITrans_r101_fpn_2x_roas_768/epoch_12.pth')

    roitransformer.inference_single_vis(r'demo/demo_img.png',
                                       r'demo/demo_img_out.jpg',
                                        (512, 512),
                                       (1024, 1024))
